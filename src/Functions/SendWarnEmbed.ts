...
export function SendWarnEmbed(warnedMember: User, reason?: string, author?: User, dynoStyle?: boolean | undefined): MessageEmbed {
    if (!warnedMember) throw new Error("Demilia: No member provided.");
    if (typeof warnedMember !== typeof User) HandleType("user");
